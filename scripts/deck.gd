...
var player_deck: Array = ["knight", "archer", "demon"]
...
func draw_card() -> void:
	...
	new_card.get_node("%Attack").text = str(CARD_DATABASE.CARDS[card_drawn_name][0])
	new_card.get_node("%Health").text = str(CARD_DATABASE.CARDS[card_drawn_name][1])
